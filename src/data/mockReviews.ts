...
export const INITIAL_REVIEWS: Review[] = [
  ...
  },
  {
    ...
    date: '2026-08-27',
    relativeTime: '1d ago',
    text: 'Food flavor was solid (the truffle pasta was delicious), but the portion size for a $38 entree was surprisingly small. Also waited about 25 minutes for the dessert menu to be brought over even though only half the tables were occupied. Good vibe, but value could be better.',
    sentiment: 'neutral',
    category: 'pricing',
    urgency: 'medium',
  ...
  },
  {
    ...
    date: '2026-08-26',
    relativeTime: '2d ago',
    text: 'Great craft beer selection and the wood-fired pizza crust is incredible! Only deduction is that the patio area was a bit cluttered with empty glassware from previous tables on a Friday night. Otherwise a top spot for Friday happy hour.',
    sentiment: 'positive',
